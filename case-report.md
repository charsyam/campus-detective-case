# 사건 조사 보고서
## 1. 현재위치
/c/detective-case/campus-detective-case
## 2. 사건자료목록
total 28
drwxr-xr-x 1 신현욱 197121    0 May 22 14:41 ./
drwxr-xr-x 1 신현욱 197121    0 May 22 14:17 ../
drwxr-xr-x 1 신현욱 197121    0 May 22 14:28 .git/
drwxr-xr-x 1 신현욱 197121    0 May 22 14:17 .github/
-rw-r--r-- 1 신현욱 197121 1252 May 22 14:17 README.md
drwxr-xr-x 1 신현욱 197121    0 May 22 14:17 case/
-rw-r--r-- 1 신현욱 197121 3828 May 22 14:17 case-report-sample.md
-rw-r--r-- 1 신현욱 197121  110 May 22 15:33 case-report.md
-rwxr-xr-x 1 신현욱 197121 7637 May 22 14:17 check_report.py*
drwxr-xr-x 1 신현욱 197121    0 May 22 14:17 docs/
drwxr-xr-x 1 신현욱 197121    0 May 22 14:17 evidence/
drwxr-xr-x 1 신현욱 197121    0 May 22 14:17 project/
drwxr-xr-x 1 신현욱 197121    0 May 22 15:05 workspace/
## 2-1. 폴더별 자료 목록
### case
briefing.md
suspects.md
...
./grep:1:evidence/access.log:12:2026-05-20 08:46:10 INFO GET /project/final_report.md 404 user=jimin
./grep:5:evidence/access.log:23:2026-05-20 08:52:03 INFO GET /project/final_report.md 200 user=jimin
./grep:10:evidence/access.log:32:2026-05-20 08:57:02 INFO GET /project/final_report.md 404 user=jimin
./grep:13:evidence/chat.log:7:2026-05-20 08:46 jimin: 응. 마지막 파일은 final_report.md.
./grep:20:evidence/file-events.log:16:2026-05-20 08:52:03 OPEN project/final_report.md user=jimin
./grep:27:evidence/file-events.log:26:2026-05-20 08:57:02 CHECK project/final_report.md user=jimin status=missing
...
./evidence/file-events.log:25:2026-05-20 08:56:18 CHECK project/final_report.md user=sora status=missing
./evidence/file-events.log:28:2026-05-20 08:58:03 CHECK submit/status user=sora status=missing_final_report
./grep:2:evidence/access.log:18:2026-05-20 08:49:53 INFO GET /project/final_report.md 404 user=sora
./grep:3:evidence/access.log:21:2026-05-20 08:51:02 INFO POST /upload 201 user=sora file=final_report.md
./grep:4:evidence/access.log:22:2026-05-20 08:51:22 INFO GET /project/final_report.md 200 user=sora
./grep:7:evidence/access.log:28:2026-05-20 08:55:05 INFO GET /project/final_report.md 200 user=sora
./grep:9:evidence/access.log:31:2026-05-20 08:56:18 INFO GET /project/final_report.md 404 user=sora
./grep:11:evidence/access.log:35:2026-05-20 08:58:25 INFO GET /project/final_report.md 404 user=sora
./grep:14:evidence/chat.log:8:2026-05-20 08:47 sora: 아직 final_report 없어서 내가 올릴게.
./grep:15:evidence/chat.log:9:2026-05-20 08:50 sora: final_report.md 업로드 준비 중.
./grep:16:evidence/chat.log:10:2026-05-20 08:51 sora: final_report.md 올렸어.
./grep:17:evidence/chat.log:15:2026-05-20 08:56 sora: 잠깐, final_report가 안 보여.
./grep:18:evidence/file-events.log:14:2026-05-20 08:51:02 UPLOAD project/final_report.md user=sora
./grep:23:evidence/file-events.log:21:2026-05-20 08:55:03 OPEN project/final_report.md user=sora
./grep:26:evidence/file-events.log:25:2026-05-20 08:56:18 CHECK project/final_report.md user=sora status=missing
./grep:28:evidence/file-events.log:28:2026-05-20 08:58:03 CHECK submit/status user=sora status=missing_final_report
...
./grep:6:evidence/access.log:24:2026-05-20 08:52:41 INFO GET /project/final_report.md 200 user=minho
./grep:8:evidence/access.log:30:2026-05-20 08:56:01 INFO POST /file/action 200 user=minho target=final_report.md result=removed
./grep:12:evidence/chat.log:6:2026-05-20 08:45 minho: 파일 이름 규칙이 final_report.md 맞지?
./grep:21:evidence/file-events.log:17:2026-05-20 08:52:41 OPEN project/final_report.md user=minho
./grep:24:evidence/file-events.log:23:2026-05-20 08:55:50 RENAME project/final-report.md project/final_report.md user=minho status=failed
./grep:25:evidence/file-events.log:24:2026-05-20 08:56:01 FILE_EVENT target=project/final_report.md user=minho action=cleanup result=removed
...
./grep:17:evidence/chat.log:15:2026-05-20 08:56 sora: 잠깐, final_report가 안 보여.
./grep:18:evidence/file-events.log:14:2026-05-20 08:51:02 UPLOAD project/final_report.md user=sora
./grep:19:evidence/file-events.log:15:2026-05-20 08:51:20 CHECK project/final_report.md user=system
./grep:20:evidence/file-events.log:16:2026-05-20 08:52:03 OPEN project/final_report.md user=jimin
./grep:21:evidence/file-events.log:17:2026-05-20 08:52:41 OPEN project/final_report.md user=minho
./grep:22:evidence/file-events.log:18:2026-05-20 08:53:11 COPY project/final_report.md project/final_report_backup.md user=system
./grep:23:evidence/file-events.log:21:2026-05-20 08:55:03 OPEN project/final_report.md user=sora
./grep:24:evidence/file-events.log:23:2026-05-20 08:55:50 RENAME project/final-report.md project/final_report.md user=minho status=failed
./grep:25:evidence/file-events.log:24:2026-05-20 08:56:01 FILE_EVENT target=project/final_report.md user=minho action=cleanup result=removed
./grep:26:evidence/file-events.log:25:2026-05-20 08:56:18 CHECK project/final_report.md user=sora status=missing
./grep:27:evidence/file-events.log:26:2026-05-20 08:57:02 CHECK project/final_report.md user=jimin status=missing
./grep:28:evidence/file-events.log:28:2026-05-20 08:58:03 CHECK submit/status user=sora status=missing_final_report
./grep:29:evidence/file-events.log:29:2026-05-20 08:58:20 RESTORE project/final_report.md user=admin source=backup
...
./workspace/evidence/file-events.log:28:2026-05-20 08:58:03 CHECK submit/status user=sora status=missing_final_report
  157  grep -rn "unknown" .
  158  grep -rn "minho" .
  159  grep -rn "final_report" .
  160  grep -rn "removed" evidence
  161  grep -rn "rfinal_report" . | grep "minho"
  162  pwd
  163  ls -al
  164  code .
  165  echo "## 8. 오늘 사용한 명령어" >> case_report.md
  166  history | tail >> case-report.md
결론:
...
주요 행위자는 minho로 추정된다.## Appendix. 추가 분석
### 사용자별 활동량
      3 user=admin
     23 user=jimin
     18 user=minho
