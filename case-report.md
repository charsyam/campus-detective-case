...
## 1. 현재 위치
/c/users/Administrator/campus-detective-case
 ## 2. 사건 자료 목록
total 38
drwxr-xr-x 1 Administrator 197121    0 May 22 15:23 ./
drwxr-xr-x 1 Administrator 197121    0 May 22 15:18 ../
drwxr-xr-x 1 Administrator 197121    0 May 22 14:33 .git/
drwxr-xr-x 1 Administrator 197121    0 May 22 14:23 .github/
-rw-r--r-- 1 Administrator 197121 1252 May 22 14:23 README.md
drwxr-xr-x 1 Administrator 197121    0 May 22 14:23 case/
-rw-r--r-- 1 Administrator 197121 3828 May 22 14:23 case-report-sample.md
-rw-r--r-- 1 Administrator 197121  165 May 22 15:28 case-report.md
-rwxr-xr-x 1 Administrator 197121 7637 May 22 14:23 check_report.py*
drwxr-xr-x 1 Administrator 197121    0 May 22 14:23 docs/
drwxr-xr-x 1 Administrator 197121    0 May 22 14:23 evidence/
-rw-r--r-- 1 Administrator 197121    2 May 22 15:23 memo.txt
drwxr-xr-x 1 Administrator 197121    0 May 22 14:23 project/
drwxr-xr-x 1 Administrator 197121    0 May 22 14:55 workspace/
 ## 2-1. 폴더별 자료 목록
### case
briefing.md
suspects.md
...
./workspace/evidence/file-events.log:26:2026-05-20 08:57:02 CHECK project/final_report.md user=jimin status=missing
./workspace/evidence/file-events.log:28:2026-05-20 08:58:03 CHECK submit/status user=sora status=missing_final_report
unknown 검색 결과 : $ grep -rn unknown .
./.git/hooks/update.sample:122:         echo *** Update hook: unknown type of update to ref of type  >&2
...
가장 중요한 증거:
위 용의자별 단서: 검색 결과에 올려둔 minho의 result=removed

가장 의심되는 상황:
minho가 파일 이름 정리를 한다고 말했고 해당 과정 수행 중 final_report를 실수로 삭제한 것으로 추정된다.

아직 확실하지 않은 점:
파일을 삭제한 이유를 무엇이라고 확실하게 단정지을 수 없다.


## 7. Git 저장 결과
 
브랜치: detective/CBR20266112

커밋: "case-report 작성" 으로 커밋할 예정입니다.

## 8. 오늘 사용한 명령어

지난 주 강의.실습한 git commit과 branch 관련 명령어들. 그 외
-grep -n
grep 명령어를 이용한 관련 내역 검색.
-grep -rni
위 명령어를 사용, 관련 내역을 좀 더 넓은 범위에서 검색.
-head
파일의 기록 초반부만 선택적으로 확인 가능.
-tail
파일의 기록 맨 마지막 부분만 선택적으로 확인.
-cat
간단하게 파일의 내용 확인 가능.
-less
